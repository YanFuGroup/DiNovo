...
mass_r004 = 3.988142
mass_r040 = 4.025110
mass_double_k = mass_k080 - mass_k602
mass_double_r = mass_r040 - mass_r004
# print(mass_double_k,mass_double_r)
mass_AA = {'_PAD': 0.0,
           '_GO': 0.0,
           '_EOS': mass_H2O,
           'A': 71.03711,  # 0
           # 'R(R004)': 156.10111 + 3.988142,  # 1
           # 'R': 156.10111,
...
# try_last_aa_mass_dict = {"A_KK": 128.09496 + 8.014204, "A_RR": 156.10111 + 3.988142, "B": 156.10111 + 3.988142,
#                          "C": 128.09496 + 8.014204}
# try_last_aa_id_dict = {"A_KK": 13, "A_RR": 4, "B": 4, "C": 13}
# lys_first_aa_mass_dict = {"A_KK": 128.09496 + 8.014204, "A_RR": 156.10111 + 3.988142, "B": 128.09496 + 8.014204,
#                           "C": 156.10111 + 3.988142}
# lys_first_aa_id_dict = {"A_KK": 13, "A_RR": 4, "B": 13, "C": 4}
...
try_last_aa_mass_dict = {"A_KK": mass_AA["K"], "A_RR": mass_AA["R"], "B": mass_AA["R"], "C": mass_AA["K"],
                         "D": mass_AA["K"], "E": mass_AA["R"], "F": mass_AA["_GO"], "G": mass_AA["_GO"],
                         "H": mass_AA["_GO"]}
lys_first_aa_mass_dict = {"A_KK": mass_AA["K"], "A_RR": mass_AA["R"], "B": mass_AA["K"], "C": mass_AA["R"],
                          "D": mass_AA["_GO"], "E": mass_AA["_GO"], "F": mass_AA["K"], "G": mass_AA["R"],
                          "H": mass_AA["_GO"]}
...
def calc_abs_mass_tol(mass, mass_tol, mass_tol_ppm_unit):
    if mass_tol_ppm_unit:
        return mass *  1e6 / (1e6+mass_tol), mass *  1e6 / (1e6-mass_tol)
    else:
        return -mass_tol, mass_tol

def judge_mass_tol_ppm(mass, calc_mass, mass_tol):

    delta = mass - calc_mass

    flag_tol = True if abs(delta) * 1e6/calc_mass <= mass_tol else False

    # flag_big = True if ((delta > 0) and (not flag_tol)) else False

    # return flag_tol, flag_big
    return flag_tol

def judge_mass_tol_da(mass, calc_mass, mass_tol):
    delta = calc_mass - mass

    flag_tol = True if abs(delta) <= mass_tol else False
...
col_feature_id = "feature id"
col_mirror_category = "mirror category"
col_precursor_mz = "try m/z"
col_precursor_charge = "try z"
col_rt_mean = "rt_mean"
col_raw_sequence = "try seq"
lys_col_precursor_mz = "lys m/z"
lys_col_precursor_charge = "lys z"
lys_col_raw_sequence = "lys seq"
