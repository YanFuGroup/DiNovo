...
from denovo_cython_modules import get_ion_index
...
class IonCNNDenovo(object):
    def __init__(self, args, device):
        ...
        if args.type:
            ...
            config.mass_ID[4] = 156.10111   # 写死了，别改config
    ...
    def _beam_search(self, model_wrapper: InferenceModelWrapper,
        ...
        for feature_index in range(num_features):
            ...
            spectrum_state = (
                ...
                batch_precursormass[feature_index])
            #
    ...
    def _get_start_point(self, feature_dp_batch: list) -> tuple:
        ...
        forward_start_point_lists = [BeamSearchStartPoint(prefix_mass=mass_GO,
                                                          ...
                                                          mass_tol_ppm_unit=self.mass_ppm,
